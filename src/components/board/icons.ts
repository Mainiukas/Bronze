/*
 * The only drawn shapes left on the board (industries use the pictures in
 * assets/icons). Filled silhouettes centred on (0, 0).
 */

/** Steam locomotive: the rail-era badge, if its picture can't be loaded. */
...
/** Barrel on a trade hub's bonus badge, about 8 units tall. */
